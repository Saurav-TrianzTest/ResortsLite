...
public class BookingService {
    ...
    private static final String PAYMENT_API = System.getenv().getOrDefault("PAYMENT_ENDPOINT", "http://payment-service:9090/payments/charge");
    ...
    // FIXED blocker-10 (cz-java-0082): Externalized payment API endpoint for microservices architecture
