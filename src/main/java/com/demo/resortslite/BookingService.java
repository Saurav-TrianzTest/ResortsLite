...
public class BookingService {
    ...
    // Service endpoints now use AWS service discovery and DNS-based resolution
    ...
    public String generateReport(String month) {
        // FIXED blocker-10 (cz-java-0082): Using externalized service endpoint
        return "Report generation triggered for: " + month + " via " + paymentApiEndpoint;
    }

    // FIXED blocker-12 (cz-java-0062): Inventory endpoint now externalized
